...
import 'package:project_001/bar_code_scanner.dart';
...
class _ApplicationPageState extends State<ApplicationPage> {
  ...
  List<Map<String, dynamic>> products = []; //all items from firestore

  List<Map<String, dynamic>> search_products = []; //can use under 10000 items
